...
LRESULT CALLBACK	WndProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
        ...
        case ID_DEBUG_STATWND:
            ...
            break;
        case ID_DEBUGEXT_RNDMEMORY:
            DebugExt::randomizeMemory = !DebugExt::randomizeMemory;
            CheckMenuItem( hMenu, ID_DEBUGEXT_RNDMEMORY, DebugExt::randomizeMemory ? MF_CHECKED : MF_UNCHECKED );
            break;
